...
class jogosController {
    ...
    telaInicial = (requisicao, resposta) => { 
        ...
        resposta.sendFile('C:/Users/heito/OneDrive/Área de Trabalho/aaaaaaa/gameranking/view/jogos/pagina-jogos.html')
    }

    telaFormulario = (requisicao, resposta) => { 
        resposta.set('Content-Type', 'text/html')
        resposta.sendFile('C:/Users/heito/OneDrive/Área de Trabalho/aaaaaaa/gameranking/view/jogos/cadastro/cadastro-jogos.html')
    }
}
